# @zitterorg/voluptates-reprehenderit

[![NPM version](https://img.shields.io/npm/v/@zitterorg/voluptates-reprehenderit.svg?style=flat)](https://npmjs.org/package/@zitterorg/voluptates-reprehenderit)
[![NPM downloads](https://img.shields.io/npm/dm/@zitterorg/voluptates-reprehenderit.svg?style=flat)](https://npmjs.org/package/@zitterorg/voluptates-reprehenderit)
![CI](https://github.com/zitterorg/voluptates-reprehenderit/workflows/CI/badge.svg)
...
```shell
yarn add --dev @zitterorg/voluptates-reprehenderit
```

Or

```shell
npm install --save-dev @zitterorg/voluptates-reprehenderit
```
...
const eslintPluginEmberRecommended = require('@zitterorg/voluptates-reprehenderit/configs/recommended');
...
💼 [Configurations](https://github.com/zitterorg/voluptates-reprehenderit#-configurations) enabled in.\
✅ Set in the `recommended` [configuration](https://github.com/zitterorg/voluptates-reprehenderit#-configurations).\
![gjs logo](/docs/svgs/gjs.svg) Set in the `recommended-gjs` [configuration](https://github.com/zitterorg/voluptates-reprehenderit#-configurations).\
![gts logo](/docs/svgs/gts.svg) Set in the `recommended-gts` [configuration](https://github.com/zitterorg/voluptates-reprehenderit#-configurations).\
...
If you have any suggestions, ideas, or problems, feel free to [create an issue](https://github.com/zitterorg/voluptates-reprehenderit/issues/new), but first please make sure your question does not repeat [previous ones](https://github.com/zitterorg/voluptates-reprehenderit/issues).

### Creating a New Rule

- [Create an issue](https://github.com/zitterorg/voluptates-reprehenderit/issues/new) with a description of the proposed rule
- Create files for the [new rule](https://eslint.org/docs/developer-guide/working-with-rules):
  ...
  - `docs/rules/new-rule.md` (documentation, start from the template -- [raw](https://raw.githubusercontent.com/ember-cli/@zitterorg/voluptates-reprehenderit/master/docs/rules/_TEMPLATE_.md), [rendered](docs/rules/_TEMPLATE_.md))
